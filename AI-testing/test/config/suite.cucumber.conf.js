...
exports.config = {
    ...
    cucumberOpts: {
        require: ['./test/stepDefinitions/given.js', './test/stepDefinitions/when.js', './test/stepDefinitions/then.js', './test/stepDefinitions/testHooks.js'],   // <string[]> (file/dir) require files before executing features
        ...
        tags: [],
        //tagExpression: tags,      // <string> (expression) only execute the features or scenarios with tags matching the expression, see https://docs.cucumber.io/tag-expressions/
